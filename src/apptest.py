...
def main():
    ...
    muon        =  PhysOb_Page_TwoColumn(phys_ob="Muon",      dic_of_trees=input_trees,  branches2plot=["mu_pt","mu_eta","mu_phi","mu_e"])
    electron    =  PhysOb_Page_TwoColumn(phys_ob="Electron",  dic_of_trees=input_trees,  branches2plot=["el_pt","el_eta","el_phi","el_e"])
    jet         =  PhysOb_Page_TwoColumn(phys_ob="Jet",       dic_of_trees=input_trees,  branches2plot=["jet_pt","jet_eta","jet_phi","jet_e"])
